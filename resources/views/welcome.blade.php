    ...
    <main>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-7">
                                <div class="slider__content text-left">
                                    <span class="sub-title left-line pl-80 mb-35">Crowd Founding </span>
                                    <h1 class="main-title mb-35" data-animation="fadeInUp2" data-delay=".2s">Change
                                        World
                                        <span>Better Future.</span>
                                    </h1>
                                    <ul class="btn-list">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-12">
                        <div class="projects grey-bg d-sm-flex mb-30 wow fadeInUp2 animated" data-wow-delay='.1s'>
                            <div class="projects__thumb">
                                <img src="../../../../devsnews.com/template/fande/fande/assets/img/project/01.jpg/index.html"
                                    alt="">
                            </div>
                            <div class="projects__content">
                                ...
                                <div class="projects__content--manager">
                                    <ul class="project-manager">
                                        <li><a href="#"><img
                                                    src="../../../../devsnews.com/template/fande/fande/assets/img/project/01.png/index.html"
                                                    alt="">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12">
                        <div class="projects grey-bg d-sm-flex mb-30 wow fadeInUp2 animated" data-wow-delay='.3s'>
                            <div class="projects__thumb">
                                <img src="../../../../devsnews.com/template/fande/fande/assets/img/project/02.jpg/index.html"
                                    alt="">
                            </div>
                            <div class="projects__content">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12">
                        <div class="projects grey-bg d-sm-flex mb-30 wow fadeInUp2 animated" data-wow-delay='.5s'>
                            <div class="projects__thumb">
                                <img src="../../../../devsnews.com/template/fande/fande/assets/img/project/03.jpg/index.html"
                                    alt="">
                            </div>
                            <div class="projects__content">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12">
                        <div class="projects grey-bg d-sm-flex mb-30 wow fadeInUp2 animated" data-wow-delay='.7s'>
                            <div class="projects__thumb">
                                <img src="../../../../devsnews.com/template/fande/fande/assets/img/project/04.jpg/index.html"
                                    alt="">
                            </div>
                            <div class="projects__content">
                        ...
                        <div class="about__wrapper pl-85">
                            <div class="section-title text-left mb-35 wow fadeInUp2 animated" data-wow-delay='.1s'>
                                ...
                                <h2>We’ve 25+ Years Of Experienced In <br>
                                    <span>Crowd Founding</span>
                                </h2>
                            </div>
                            <div class="partner-list d-sm-flex align-items-center justify-content-between mb-40 wow fadeInUp2 animated"
                                data-wow-delay='.1s'>
                            ...
                            <div class="funding-list">
                                <div class="crowd-box d-flex align-items-center pb-30 mb-40 wow fadeInUp2 animated"
                                    data-wow-delay='.1s'>
                                ...
                                <a href="about.html" class="theme_btn theme_btn_bg wow fadeInUp2 animated"
                                    data-wow-delay='.1s'>Learn more <i class="far fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-8 offset-xl-2">
                        <div class="donation-wrapper">
                            ...
                            <ul class="btn-list text-center mb-30 wow fadeInUp2 animated" data-wow-delay='.3s'>
                                <li><a class="theme_btn theme_btn_bg" href="about.html" data-animation="fadeInLeft"
                                        data-delay=".7s">explore more <i class="far fa-arrow-right"></i></a>
                                </li>
                                <li><a class="theme_btn theme-border-btn" href="contact.html"
                                        data-animation="fadeInLeft" data-delay=".7s">donate now <i
                                            class="far fa-arrow-right"></i></a>
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="projects projects-02 white-bg mb-30 wow fadeInUp2 animated" data-wow-delay='.1s'>
                            <div class="projects__thumb pos-rel">
                                <img src="../../../../devsnews.com/template/fande/fande/assets/img/project/05.jpg/index.html"
                                    alt="">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="projects projects-02 white-bg mb-30 wow fadeInUp2 animated" data-wow-delay='.3s'>
                            <div class="projects__thumb pos-rel">
                                <img src="../../../../devsnews.com/template/fande/fande/assets/img/project/06.jpg/index.html"
                                    alt="">
                                <a href="#" class="new-tag">new</a>
                            </div>
                            <div class="projects__content">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="projects projects-02 white-bg mb-30 wow fadeInUp2 animated" data-wow-delay='.5s'>
                            <div class="projects__thumb pos-rel">
                                <img src="../../../../devsnews.com/template/fande/fande/assets/img/project/07.jpg/index.html"
                                    alt="">
                                <a href="#" class="new-tag">new</a>
                            </div>
                            <div class="projects__content">
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-6 col-lg-6">
                            <div class="subscribe-wrapper">
                                <div class="section-title text-left mb-30 wow fadeInLeft animated"
                                    data-wow-delay='.1s'>
        ...
        <section class="testimonial-area theme-bg2 pt-125 pb-130" style="background-image:url(assets/img/bg/04.png);">
            <div class="container">
                <div class="row">
                    <div class="col-xl-10 offset-xl-1">
                        <div class="section-title white-title text-center mb-70 wow fadeInUp2 animated"
                            data-wow-delay='.1s'>
                            <h6 class="left-line pl-75 pr-75">Clients Feedback</h6>
                            <h2>356754+ Peoples Say<br>
                                <span>About Given </span>
                            </h2>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row testimonial-active">
                        <div class="col-xl-6">
                            <div class="testimonial-item wow fadeInUp2 animated" data-wow-delay='.1s'>
                                ...
                                <div class="author-content mb-15">
                                    <h5 class="left-line pl-40">David Michel,<span class="desig">CEO & Founder</span>
                                    </h5>
                                </div>
                                <p class="semi-title mb-15">But I must explain to you how all this mistake denouncing
                                    pleasure and praising pain was born and I will give you a complete account of the
                                    system, and expound the actual teachings of the great explorer of ter-builder</p>
                        ...
                        <div class="col-xl-6">
                            <div class="testimonial-item wow fadeInUp2 animated" data-wow-delay='.3s'>
                                ...
                                <div class="author-content mb-15">
                                    <h5 class="left-line pl-40">Somalia Silva,<span class="desig">CEO &
                                            Founder</span></h5>
                                </div>
                                <p class="semi-title mb-15">But I must explain to you how all this mistake denouncing
                                    pleasure and praising pain was born and I will give you a complete account of the
                    ...
                    <div class="col-xl-4 col-lg-8 col-md-12">
                        <div class="blog-wrapper mb-30">
                            <div class="section-title text-left mb-70 wow fadeInUp2 animated" data-wow-delay='.1s'>
                                ...
                                <a href="blog-details.html" class="theme_btn theme_btn2 theme_btn_bg_02">view all news
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp2 animated" data-wow-delay='.3s'>
                        <div class="blogs mb-30 mr-15">
                            ...
                            <div class="blogs__content">
                                ...
                                <h4 class="mb-20"><a href="blog-details.html">How Make Cross-Browser Testing More
                                        Lambda.</a></h4>
                                <ul class="project-manager">
                                    <li><a href="#"><img src="assets/img/blog/03.png" alt="">
                                            <span>David Zon</span></a></li>
                                    <li>
                                        <a class="more_btn_02" href="blog-details.html">Read more <i
                                                class="far fa-arrow-right"></i></a>
                                    </li>
                                </ul>
                            </div>
